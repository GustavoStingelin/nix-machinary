...
# Go verification
zwm-format:
    GOTOOLCHAIN=go1.26.5 go -C zwm fmt ./...

zwm-test:
    GOTOOLCHAIN=go1.26.5 go -C zwm test ./...

zwm-race:
    GOTOOLCHAIN=go1.26.5 go -C zwm test -race ./...

zwm-vet:
    GOTOOLCHAIN=go1.26.5 go -C zwm vet ./...

zwm-mock:
    GOTOOLCHAIN=go1.26.5 go -C zwm tool mockery --config .mockery.yml
